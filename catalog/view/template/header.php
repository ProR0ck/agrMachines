...
<head>
    ...
    <link href="<?= $link ?>/catalog/view/javascript/font-awesome/css/font-awesome.min.css" rel="stylesheet"
          type="text/css"/>
    ...
    <div class="container">
        <div id="top-links" class="nav pull-right">
            <ul class="list-inline">
                <li><a href="http://localhost:8888/opencart/index.php?route=information/contact"><i
                                class="fa fa-phone"></i></a> <span class="hidden-xs hidden-sm hidden-md"> +7(499)-777-77-77</span>
                </li>
                <li class="dropdown">
                    <?php if (!isset($_SESSION['log'])) { ?>
                        <a href="http://localhost:8888/opencart/index.php?route=account/account" title="Личный кабинет"
                    ...
                    <?php } else { ?>
                        <a href="<?= $route->map['userInfo'] ?>" title="Личный кабинет" class="dropdown-toggle"
...
<header>
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <div id="logo"><a href="<?= $link ?>" class="gref"><img src="<?= $link ?>/catalog/view/image/logo.png"
                                                                        title="Ваш магазин"
                ...
                <div id="cart" class="btn-group btn-block">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li>
                            ...
                            <?php if ($makeOrder) { ?>
                                <p class="text-right">
                                    <a href="<?= $route->map['newOrder'] ?>"><strong> <i class="fa fa-share"></i>
                                            Оформить заказ&nbsp;&nbsp;&nbsp;</strong>
                                    </a>
                                </p>
                            <?php } ?>
