    ...
    <div class="col-sm-12">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <ul>
                <?php $products = $order->getBasketProducts($value['id_order']); foreach ($products as $product) {?>
                    <li><a href="<?=$route->map['product'].$product['id_vehicle']?>"><?=$product['mark_name']?> <?=$product['model_name']?></a></li>
                <?php }?>
                    </ul>
                </td>
                <td>
